...
严格回退到结构化 Infobox 国家/地区字段。兼容的精确合拍证据可以收录；独立来源冲突
或缺失证据会进入 REVIEW，明确的非日本证据会被排除。跨季度 Movie 搜索回看会先被
过滤为无关候选，不会从标题、简介或语言猜测事实。日本范围 REVIEW 使用独立的
`bgmb classify BGM_ID --japanese|--non-japanese|--clear` 裁决。
