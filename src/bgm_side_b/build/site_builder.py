...
def _archive_html(revisions: Mapping[str, str]) -> bytes:
    body = (
        ...
        '<span class="field-label" id="archive-year-label">年份</span>'
        '<div id="archive-year" data-archive-year-select aria-labelledby="archive-year-label"></div></div>'
        ...
        '<p class="no-results" data-no-results hidden><strong>没有找到匹配作品</strong><br><span class="no-results__code">NO MATCH / 00</span> <button type="button" class="text-button" data-clear-all>清除筛选</button></p>'
...
def _settings_html(
    ...
    body = (
        ...
        '<p class="archive-intro__summary">管理离线季度、下载任务、存储与应用。</p>'
        '</div></section><div class="settings-sections">'
        '<section class="settings-section" aria-labelledby="settings-offline-title">'
        '<header><p>01 / OFFLINE ARCHIVE</p><h2 id="settings-offline-title">离线季度</h2></header>'
        '<div class="settings-offline-content"><div data-settings-quarters>'
        '<p class="loading-state">正在读取季度状态…</p></div></div></section>'
        '<section class="settings-section" aria-labelledby="settings-queue-title">'
        '<header><p>02 / DOWNLOAD TASK</p><h2 id="settings-queue-title">下载任务</h2></header>'
        '<div data-settings-queue><p class="loading-state">队列空闲</p></div></section>'
        '<section class="settings-section" aria-labelledby="settings-selector-title">'
        '<header><p>03 / BULK DOWNLOAD</p><h2 id="settings-selector-title">批量下载</h2></header>'
        '<div data-settings-selector><p class="loading-state">正在读取可用季度…</p></div></section>'
        '<section class="settings-section" aria-labelledby="settings-storage-title">'
        '<header><p>04 / STORAGE &amp; APP</p><h2 id="settings-storage-title">存储与应用</h2></header>'
...
def _site_header(
    ...
    *,
    ...
    return (
        ...
        f'<a href="{html.escape(archive_href, quote=True)}">档案</a>'
        ...
        'data-menu-open="false" popover="auto">'
